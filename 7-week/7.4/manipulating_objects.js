...
// Why did that work?
//
// The delete step gave me a little trouble, and lines 25..27 were also kind 
// of a pain. For the delete step (I know this isn't kosher) I was
// guessing at the syntax and after a few guesses it worked. The wording on 
// the last few steps were just a little confusing. I was trying to piece 
// together the syntax from the earlier steps and that took a few tries. I 
// eventually nested the object like I nested the other steps (like x.y = {})
// then I just went another level down adding carter to terah.children.carter 
// and that did the trick and made a lot of sense to me. It's like a file tree.
//
// -How difficult was it to add and delete properties outside of the object 
// itself?
//
// Not hard, I found it pretty intuitive. 
//
// -What did you learn about manipulating objects in this challenge?
//
// I learned how to make the JS equivelent of a Ruby hash and I learned a lot 
// about targeting specific objects within another object.
//
